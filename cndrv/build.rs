fn main() {
    ...
    println!("cargo:rustc-link-lib=dylib=cndrv");
    println!("cargo:rustc-link-lib=dylib=cnrtc");
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("cn.*")
        .allowlist_function("cnrtc.*")
        .allowlist_item("CN.*")
        // Annotate the given type with the #[must_use] attribute.
        .must_use_type("CNresult")
        .must_use_type("cnrtcStatus")
